    ...
    def get_images(self, word='表情包'):
        ...
        while pn < self.__amount:
            ...
            url = 'http://image.baidu.com/search/avatarjson?tn=resultjsonavatarnew&ie=utf-8&word=' + search + '&cg=girl&pn=' + str(
                pn) + '&rn=60&itg=0&z=0&fr=&width=&height=&lm=0&ic=0&s=0&st=-1&gsm=1e0000001e'
            # 设置header防ban
            try:
                time.sleep(self.time_sleep)
...
if __name__ == '__main__':
    ...
    # crawler.start('表情包', 10, 2)  # 抓取关键词为 “表情包”，总数为 1 页（即总共 1*60=60 张），开始页码为 2
    crawler.start('表情包', 100, 10)  # 抓取关键词为 “表情包”，总数为 10 页（即总共 10*60=600 张），起始抓取的页码为 1
